    ...
    return (
        <div className="min-h-screen bg-finnio-sidebar flex flex-col items-center justify-center">
            ...
            <div className="bg-finnio-sidebar-dark rounded-2xl p-8 w-[380px] flex flex-col gap-4">
                ...
                <div>
                    <label className="text-xs opacity-70 mb-1 block text-white">Email</label>
                    <input
                        value={email}
                ...
                <button
                    ...
                    className="w-full text-white py-2 bg-finnio-card-2 rounded-lg text-sm font-semibold hover:bg-gray-500 transition-all">
                        Sign In
                </button>

                <button className="w-full text-white py-2 bg-white/10 rounded-lg text-sm hover:bg-white/20 transition-all flex items-center justify-center gap-2">
            ...
            <p className="text-xs opacity-40 mt-6 text-center text-white max-w-sm">
